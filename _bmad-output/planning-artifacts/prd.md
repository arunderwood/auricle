...
### Persona: the user, the single user
...
- **FR21 [MVP]:** the user can review detected speakers in a native attribution UI panel after diarization completes, with the pipeline blocked on his input before summarization runs.
